...
covariancia:    addi sp, sp, -20                # aloca espaço para 5 variáveis na pilha
                sw  a1, 0(sp)                   # salva snapshot de a1 (tamanho dos vetores)
...
mult:           add a7, a0, zero                # a7: referência temporaria do vetor 1
                ...
                bne a1, zero, mult              # caso tiver mais elementos para processar, prossegue para próxima multiplicação
                lw  a1, 0(sp)                   # recupera snapshot de a1 (tamanho dos vetores)
                addi a7, a1, -1                 # a7: N - 1
